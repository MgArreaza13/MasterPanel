...
class tb_cliente (models.Model):
	...
	FechaCobroMensual					=	models.DateField(blank=False, null=True, default='1995-04-19' )
	...
	DateInicioContrato					=	models.DateField(blank=False, null=True, default='1995-04-19' )
